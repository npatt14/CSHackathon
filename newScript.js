...
function scanPage() {
  ...
  for(let i = 0; i < 7 && i<text.length; i++) {
    const wordArray =[];
    ...
    for(let i = 0; i < 10 && i<wordArray.length; i++){
...
newButton.setAttribute('style', 'background-color : orange');
newButton.innerText = 'RHYMEIFY TIMEIFY'
...
firstHeader.appendChild(buttonContainer);
